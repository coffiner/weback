...
namespace Wlniao.WeChat.BLL
{
	...
	{
		public static Result AddRules(string RuleName, string RuleCode, string SepType, string DoMethod, string ReContent, string RuleHelp)
		{
			return AddRules(RuleName,RuleCode,SepType,DoMethod,ReContent,RuleCode,"","sendnew");
		}
		...
		{
			return AddRules(RuleName,RuleCode,SepType,DoMethod,ReContent,RuleCode,CallBackText,"sendnew");
		}
        public static Result AddRules(string RuleName, string RuleCode, string SepType, string DoMethod, string ReContent, string RuleHelp, string CallBackText, string SendMode)
        {
		...
		public static Result AddRuleContent(string RuleGuid, string ContentType, string Title, string TextContent, string PicUrl, string ThumbPicUrl, string MusicUrl, string LinkUrl)
		{
			return AddRuleContent(RuleGuid,ContentType,Title,TextContent,PicUrl,MusicUrl,LinkUrl,"normal");
		}
		...
		public static Result EditRuleContent(string Guid, string ContentType, string Title, string TextContent, string PicUrl, string ThumbPicUrl, string MusicUrl, string LinkUrl)
		{
			return EditRuleContent(Guid,ContentType,Title,TextContent,PicUrl,ThumbPicUrl,MusicUrl,LinkUrl,"normal");
		}
